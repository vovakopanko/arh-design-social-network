      ...
      <div className={style.block__items}>
        ...
        <div className={style.block__item}>
          ...
          <div className={style.item__description}>
            ...
            важным фактором при строительстве коттеджей и частных домов является
            гидроизоляция и теплоизоляция помещения, что является главной
            составляющей комфорта в доме.
          </div>
          <div className={style.moreInfo}>
            <span
              className={style.item__button + " " + style.item__button_size}
